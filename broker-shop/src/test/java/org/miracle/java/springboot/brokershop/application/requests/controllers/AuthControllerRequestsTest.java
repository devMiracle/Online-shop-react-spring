package org.miracle.java.springboot.brokershop.application.requests.controllers;


import org.junit.jupiter.api.*;
import org.junit.jupiter.api.extension.ExtendWith;
import org.miracle.java.springboot.brokershop.BrokerShopApplication;
import org.miracle.java.springboot.brokershop.security.HibernateWebAuthProvider;
import org.miracle.java.springboot.brokershop.security.RestAuthenticationEntryPoint;
import org.miracle.java.springboot.brokershop.security.SavedReqAwareAuthSuccessHandler;
import org.miracle.java.springboot.brokershop.security.SecurityConfig;
...
public class AuthControllerRequestsTest {
    ...
    final String BASE_URL = "http://localhost:" + 8080 + "/shop/";
    ...
    public void givenLoginUrlWithCorrectCredentialsWhenLoginThenReturnOkStatus () throws Exception {
        ...
        mvc.perform(formLogin("/login")
                ...
                .password("Passwo0rd0")) // в теле запроса отправить пароль
